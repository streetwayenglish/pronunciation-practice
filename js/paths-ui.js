...
function swStart(unitNum){
  ...
  Log.d('[ui] swStart topic="'+topic+'" unit='+unitNum);
...
function cpStart(){
  Log.d('[tap] cpStartBtn (Continue) topic="'+window._emmaTopic+'" unit='+window._cpSelectedUnit);
